  ...
  <nav class="navbar-default navbar-side" role="navigation">
    <div class="sidebar-collapse">
      <ul class="nav" id="main-menu">
        ...
        <li>
          <a ><i class="fa fa-desktop"></i> <router-link style="color: #FFFFFF;background: transparent;text-shadow: none;"  to="/view1">售前可视化</router-link></a>
        </li>
        <li>
          <a><i class="fa fa-desktop"></i> <router-link style="color: #FFFFFF;background: transparent;text-shadow: none;"  to="/view2">售后可视化</router-link></a>
        </li>
      </ul>
